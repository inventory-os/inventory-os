...
export const incidentFilesTable = pgTable("incident_files", {
  id: text("id").primaryKey(),
...
export const assetFilesTable = pgTable("asset_files", {
  id: text("id").primaryKey(),
  assetId: text("asset_id").notNull(),
  kind: text("kind").notNull(),
  originalName: text("original_name").notNull(),
...
export const appSetupTable = pgTable("app_setup", {
...
export const ldapIntegrationsTable = pgTable("ldap_integrations", {
  id: integer("id").primaryKey(),
...
export const qrPublicSettingsTable = pgTable("qr_public_settings", {
  id: integer("id").primaryKey(),
  enabled: integer("enabled").notNull(),
