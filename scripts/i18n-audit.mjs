...
const likelyPlain = []
const ignoreLiteral =
  /^(true|false|null|undefined|none|all|asc|desc|available|in-use|maintenance|retired|active|upcoming|completed|new|good|fair|damaged|image|document|building|floor|room|storage|area|admin|manager|member)$/i
